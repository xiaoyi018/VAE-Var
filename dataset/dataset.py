...
# Years = {
#     'train': ['2012-01-01 00:00:00', '2015-12-31 23:00:00'],
#     'valid': ['2018-01-01 00:00:00', '2018-12-31 23:00:00'],
#     'test': ['2016-01-01 00:00:00', '2017-12-31 23:00:00'],
#     'all': ['1979-01-01 00:00:00', '2020-12-31 23:00:00']
# }
...
Years = {
    'train': ['2015-11-01 00:00:00', '2015-12-31 23:00:00'],
    'valid': ['2018-01-01 00:00:00', '2018-12-31 23:00:00'],
    'test': ['2016-01-01 00:00:00', '2017-12-31 23:00:00'],
    'all': ['1979-01-01 00:00:00', '2020-12-31 23:00:00']
}
...
class weather_dataset(Dataset):
    def __init__(self, data_dir='cluster3:s3://era5_np_float32', split='train', **kwargs) -> None:
        super().__init__()
        # print("init begin")
    ...
    def _get_meanstd(self):
        with open('./dataset/mean_std.json',mode='r') as f:
            multi_level_mean_std = json.load(f)
        with open('./dataset/mean_std_single.json',mode='r') as f:
